...
export function SendRequestModal(props: SendRequestModalProps) {
  const {
    descriptionText,
    buttonText = labels.modal.selectModal.primaryButtonText,
    title = labels.modal.sendRequestModal.title,
    portalId = "portal",
    secondaryButtonText = labels.modal.sendRequestModal.secondaryButtonText,
    onCloseModal,
    onSubmitButtonClick,
